...
function emit{IO}(l::Lexer{IO, RawToken}, kind::Kind, err::TokenError=Tokens.NO_ERR)
...
emit{IO}(l::Lexer{IO, RawToken}, kind::Kind, str::String, err::TokenError=Tokens.NO_ERR) = emit(l, kind, err)
